...
with open('C:/2ch_project/voice_transformer/transformer_model/text_data/src_200000man_vocab.pkl', 'rb') as f:
    SRC.vocab = torch.load(f)
with open('C:/2ch_project/voice_transformer/transformer_model/text_data/trg_40000man_vocab.pkl', 'rb') as f:
